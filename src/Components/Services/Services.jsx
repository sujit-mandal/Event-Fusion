...
const Services = () => {
  return (
    <div className="grid grid-cols-3 gap-5 row-span-2 my-20">
      ...
      <div className="col-span-2 grid grid-cols-3">
        <ServicesCard
          text={{
            ...
            br: "border-[1px] border-gray-400 border-l-0 border-t-0",
          }}
          icon={<FaRegHandshake />}
        />
        <ServicesCard
        ...
        <ServicesCard
          ...
          br: "border-[1px] border-gray-400 border-l-0 border-t-0 border-r-0" }}
          icon={<FaGlassCheers />}
        />
        <ServicesCard
